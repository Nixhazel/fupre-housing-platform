              ...
              <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td align="center" style="padding-bottom: 16px;">
                    ${footerText ? `<p style="margin: 0 0 16px; font-size: 14px; color: #71717a;">${footerText}</p>` : ''}
 ...
 */
export function emailButton(text: string, url: string, color: string = '#3b82f6'): string {
	return `
<table role="presentation" cellpadding="0" cellspacing="0" width="100%">
  <tr>
 ...
 */
export function emailInfoBox(content: string, type: 'info' | 'warning' | 'success' = 'info'): string {
	const colors = {
